...
export default function Navbar({user,logout}) {
  ...
  return (
   ...
   <nav className="navbar navbar-expand-md navbar-light fixed-top bg-light ">
    ...
    <>
     <li className="nav-item">
           <Link className="nav-link" to="login"><button className='btn btn-outline-primary fw-bold'> signin </button></Link>
         </li>
         <li className="nav-item">
           <Link className="nav-link" to="register"><button className='btn btn-outline-primary fw-bold'>signup</button></Link>
         </li>
    ...
    <li className="nav-item">
       <Link className="nav-link" to="login" onClick={logout}><button className='btn btn-outline-primary fw-bold ms-3'>logout</button></Link>
       </li>
    }
